...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['Pwd_reset']))
		{
			...
			$query="insert into railways_passwordresets (email, status) values(?,?)";
      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container forgot-password">
            ...
            <div class="splash-footer">&copy; 2023 - <?php echo date ('Y');?> Online Railway Reservation System | Developed By Bradley Ochieng</div>
        </div>
      </div>
    </div>
