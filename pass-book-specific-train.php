<?php
    ...
    if(isset($_POST['Book_Train']))
    {
            ...
            // $pass_book_date = $_POST['pass_book_date'];
            ...
            $query="update  railways_passenger set pass_train_number = ?, pass_train_name = ?, pass_dep_station = ?, pass_dep_time = ?,  pass_arr_station = ?, pass_train_fare = ? where pass_id=?";
            ...
            if($stmt)
            {
              $succ = "Reserved Train. Please Proceed To Check Out Page";
              header("location:pass-checkout-ticket.php");
            }
            else 
            {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_SESSION['pass_id'];
            $ret="select * from railways_passenger where pass_id=?";
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <?php
                        $id=$_GET['id'];
                        $ret="select * from railways_train where id=?";
                        $stmt= $mysqli->prepare($ret) ;
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Booking Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="pass_book_date" value="<?php echo $row->pass_book_date;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-outline-success" action="pass-train-checkout-ticket.php" value ="Book Train" name = "Book_Train" type="submit">
                          <button class="btn btn-space btn-outline-danger" type="reset">Cancel</button>
                        </p>
                    </div>
                  </form>
                </div>
