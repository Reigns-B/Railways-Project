...
<?php
	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			$query="insert into railways_passenger (pass_fname, pass_lname, pass_phone, pass_addr, pass_uname, pass_email, pass_pwd) values(?,?,?,?,?,?,?)";
      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
                ...
                <form method ="POST">
                  <div class="login-form">
                    ...
                    <div class="form-group row login-submit">
                      ...
                      <div class="col-6" style="color:purple;"><input type = "submit" name ="pass_register" class="btn btn-outline-warning btn-xl" value ="Register"></div>
                    </div>
            ...
            <div class="splash-footer"style="color:purple;">&copy; 2023 - <?php echo date ('Y');?> Online Railway Reservation System | Developed By Bradley Ochieng</div>
