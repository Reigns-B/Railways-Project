  ...
  <body>
    ...
    <!--Navbar-->
     <?php include("assets/inc/navbar.php");?>
      ...
      <div class="be-content" style="color:purple;">
        <div class="main-content container-fluid" style="color:green;">
          <div class="row">
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        ...
                        $ret="SELECT * FROM railways_train ORDER BY RAND() LIMIT 10 "; //sql code to get to ten trains randomly
