            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header">Dear <?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?>  This Is Your Booked Train Proceed to checkout your ticket!   
                <?php }?>             
                </div>
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['pass_id'];
                            $ret="SELECT * FROM railways_passenger WHERE pass_id=? && pass_fare_payment_code = ''";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
