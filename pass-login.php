...
<?php
    ...
    if(isset($_POST['pass_login']))
    {
      ...
      $stmt=$mysqli->prepare("SELECT pass_email ,pass_pwd , pass_id FROM railways_passenger WHERE pass_email=? and pass_pwd=? ");//sql to log in user
...
<head>
  ...
  <body class="be-splash-screen" style="background-color:cyan;">
    <div class="be-wrapper be-login">
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success" style="background-color:navyblue;">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="50"><span class="splash-description" style="color: Black; font-weight: bold;"><h4>Please enter your user information.</h4></span></div>
              <div class="card-body">
                ...
                <form method ="POST">
                  <div class="login-form ">
                    ...
                    <div class="form-group row login-submit">
                      <div class="col-6" ><a class="btn btn-warning btn-xl" href="pass-signup.php"style="color:purple;">Register</a></div>
            ...
            <div class="splash-footer"style="color:black;">&copy;<?php echo date ('Y');?> Online Railway Reservation System | Developed By Bradley Ochieng</div>
          </div>
        </div>
      </div>
    </div>
